...
public interface AuditVetoer {
    ...
    boolean shouldPerformChangeAudit(Session session, String entityName, Serializable entityId, Object[] entityStateOld,
                                     Object[] entityStateNew);

    boolean shouldPerformCollectionChangeAudit(Session session, String ownerEntityName, Serializable ownerEntityId, Object entity,
                                               String collectionPropertyName);

    boolean shouldPerformPersistentCollectionChangeAudit(Session session, String ownerEntityName, Serializable ownerEntityId,
