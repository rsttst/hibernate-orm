...
public class DefaultAuditVetoer implements AuditVetoer {
    ...
    @Override
    public boolean shouldPerformChangeAudit(Session session, String entityName, Serializable entityId, Object[] entityStateOld,
                                            Object[] entityStateNew) {
        return true;
    }

    @Override
    public boolean shouldPerformCollectionChangeAudit(Session session, String ownerEntityName, Serializable ownerEntityId, Object entity,
                                                      String collectionPropertyName) {
        return true;
    }

    @Override
    public boolean shouldPerformPersistentCollectionChangeAudit(Session session, String ownerEntityName, Serializable ownerEntityId,
                                                                String collectionPropertyName, PersistentCollection collection) {
        return true;
    }
