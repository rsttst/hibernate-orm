 ...
 */
public class SessionAuditProcess implements AuditProcess {
	...
	public SessionAuditProcess(RevisionInfoGenerator revisionInfoGenerator, SessionImplementor session) {
