 ...
 */
public class PerSessionAuditProcessManager implements AuditProcessManager {
	private final Map<Transaction, AuditProcess> auditProcesses;
	private final RevisionInfoGenerator revisionInfoGenerator;

	public PerSessionAuditProcessManager(RevisionInfoGenerator revisionInfoGenerator) {
	...
	public AuditProcess get(EventSource session) {
		...
		if ( auditProcess == null ) {
			...
			auditProcess = new SessionAuditProcess( revisionInfoGenerator, session );
